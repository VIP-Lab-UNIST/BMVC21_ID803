...
def args_faster_rcnn():
    ...
    parser.add_argument('--dataset',
                        help='training dataset', required=True, type=str,
...
def args_faster_rcnn_ortho_featuring(meta_parser=args_faster_rcnn):
    ...
    parser.add_argument('--uniq', type=int, default=1, choices=[1,0],help='Use uniqueness')
    parser.add_argument('--num_neg',type=int, default=1, help='The number of negaitve on one scene')
    parser.add_argument('--coap', type=int, default=1, choices=[1,0], help='Use Co-appearance')
    parser.add_argument('--co_thrd', type=float, default=0.7, help='Co appearance threshold')
